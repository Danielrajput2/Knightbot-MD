    ...
    XeonBotInc.ev.on('connection.update', async (s) => {
        ...
        if (connection == "open") {
            ...
            await XeonBotInc.sendMessage(botNumber, { 
                text: `🤖 KING B2K Bot ✓ Connected Successfully!\n\n⏰ Time: ${new Date().toLocaleString()}\n✅ Status: Online and Ready!
            ...
            console.log(chalk.magenta(`\n${global.themeemoji || '•'} YT CHANNEL: KING B2K ✓`))
            console.log(chalk.magenta(`${global.themeemoji || '•'} GITHUB: DanielRajput2`))
            console.log(chalk.magenta(`${global.themeemoji || '•'} WA NUMBER: ${owner}`))
            console.log(chalk.magenta(`${global.themeemoji || '•'} CREDIT: KING B2K ✓`))
