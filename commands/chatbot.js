...
async function handleChatbotResponse(sock, chatId, message, userMessage, senderId) {
    ...
    try {
        ...
        if (!isBotMentioned && !isReplyToBot) {
            console.log('KING B2K BOT ✓ not mentioned or replied to');
            return;
        }
...
async function getGPT3Response(userMessage) {
    try {
        ...
        const systemPrompt = {
            role: "system",
            content: "You are KING B2K ✓ CHATBOT, an intelligent and feature-rich assistant. Behave like human and talk like human. Understand how sender responds, behaves accordingly. Enhance your responses with relevant emojis when appropriate while maintaining clarity and professionalism."
        };
